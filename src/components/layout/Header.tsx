...
export const Header: React.FC = () => {
  ...
  const user = { name: 'Admin User', role: 'SUPER_ADMIN', avatar: '' }; // Mock
              ...
              {showProfileMenu && (
                ...
                >
                  ...
                  <div style={{ padding: '8px 0' }}>
                    <button style={{ width: '100%', padding: '8px 16px', textAlign: 'left', background: 'transparent', border: 'none', cursor: 'pointer', fontSize: '0.875rem', color: 'var(--text-primary)' }}>Profile Settings</button>
                    {user.role === 'SUPER_ADMIN' && (
                      <button style={{ width: '100%', padding: '8px 16px', textAlign: 'left', background: 'transparent', border: 'none', cursor: 'pointer', fontSize: '0.875rem', color: 'var(--text-primary)' }}>Admin Panel</button>
                    )}
                    <div style={{ height: '1px', background: 'var(--border-color)', margin: '4px 0' }}></div>
                    <button style={{ width: '100%', padding: '8px 16px', textAlign: 'left', background: 'transparent', border: 'none', cursor: 'pointer', fontSize: '0.875rem', color: 'var(--error)' }}>Logout</button>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
